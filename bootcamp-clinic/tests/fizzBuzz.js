...
describe("Fizz Buzz tests ", function() {
  ...
  it("should return 101 since its indivisible by 3 and 5", function() {
   ...
   it("should return `FizzBuzz` for 200", function() {
    expect(myApp.fizzBuzz(200)).to.equal('Buzz');
  });

    it("should return 304 since its indivisible by 3 and 5", function() {
    expect(myApp.fizzBuzz(304)).to.equal(304);
  });
